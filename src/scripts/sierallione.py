...
# GHI vs TModA
plt.subplot(1, 2, 1)
plt.scatter(df_soeraleone_clean['GHI'], df_soeraleone_clean['TModA'], alpha=0.5, color='darkred')
z = np.polyfit(df_soeraleone_clean['GHI'], df_soeraleone_clean['TModA'], 1)
p = np.poly1d(z)
plt.plot(df_soeraleone_clean['GHI'], p(df_soeraleone_clean['GHI']), "r--", alpha=0.8)
plt.title(f'GHI vs. TModA (r = {np.corrcoef(df_soeraleone_clean["GHI"], df_soeraleone_clean["TModA"])[0,1]:.2f})')
plt.xlabel('GHI (W/m²)')
...
# GHI vs TModB
plt.subplot(1, 2, 2)
plt.scatter(df_soeraleone_clean['GHI'], df_soeraleone_clean['TModB'], alpha=0.5, color='darkblue')
z = np.polyfit(df_soeraleone_clean['GHI'], df_soeraleone_clean['TModB'], 1)
p = np.poly1d(z)
plt.plot(df_soeraleone_clean['GHI'], p(df_soeraleone_clean['GHI']), "b--", alpha=0.8)
plt.title(f'GHI vs. TModB (r = {np.corrcoef(df_soeraleone_clean["GHI"], df_soeraleone_clean["TModB"])[0,1]:.2f})')
plt.xlabel('GHI (W/m²)')
